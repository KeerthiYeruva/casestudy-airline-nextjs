...
import type { SeatPreferences, SeatPreference, SeatType } from '../../../domain/seats/types';
import { SeatPreferencesDialogSchema, type SeatPreferencesDialogFormData } from '../../../domain/validation/schemas';
